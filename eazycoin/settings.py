...
SECRET_KEY = 'django-insecure-&#xu8k0)fazz6e@8$8)5l!8uvf@swws30bk3e-g+d5f*^)4-5l'
...
WSGI_APPLICATION = 'eazycoin.wsgi.application'
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join('c:users/user/desktop/eazycoin/static/')
STATICFILES_DIRS = [
        BASE_DIR / 'static'
         ]
# if DEBUG:
